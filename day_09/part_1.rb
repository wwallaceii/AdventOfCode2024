...
def compact_disk(file_system_map)
  end_index = file_system_map.rindex { |block| block != "." }
  free_space_index = file_system_map.index(".")

  while !free_space_index.nil? && free_space_index < end_index
    puts "free_space_index: #{free_space_index}, end_index: #{end_index}"
    file_system_map[free_space_index] = file_system_map[end_index]
    file_system_map[end_index] = "."
...
def process(file_name, debug=false)
  ...
  compact_map = compact_disk(file_system_map)
